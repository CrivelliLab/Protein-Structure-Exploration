...
if __name__ == '__main__':
    ...
    data_folder = "../../../data/split/KRAS_HRAS_24_JULY_FULL"
    ...
    # Callbacks
    csv_logger = CSVLogger('logs/'+model_def.__name__+".csv", separator=',')
    checkpointer = ModelCheckpoint(filepath='weights/'+model_def.__name__+'.hdf5', verbose=0, save_best_only=True)
