...
from binvox_io import write_binvox
...
if __name__ == '__main__':
    ...
    for pdb_i, r_i in entries:
        ...
        #file_path = pdb_list_folder + str(bounded_pdbs_data[pdb_i][0]) + '-r'+ str(r_i) +'.binvox'
        #write_binvox(file_path, pdb_3d)
