...
This Keras module has been edited to be able to flow binvox files from directory.
...
try: from PIL import Image as pil_image
...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
        ...
        white_list_formats = {'png', 'jpg', 'jpeg', 'bmp', 'binvox'}
