...
# Fit Training Data
net = ProteinNet(shape=[resize[0], resize[1], 3]); net.model.save_weights('weights.hdf5');
net.model.fit_generator(train_flow, epochs=100, steps_per_epoch=68991, validation_data=test_flow, callbacks=[save,],
validation_steps=29568)
