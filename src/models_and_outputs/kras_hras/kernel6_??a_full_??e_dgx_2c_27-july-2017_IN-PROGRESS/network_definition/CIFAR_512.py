...
class CIFAR_512:
    ...
    def __init__(self, nb_channels, nb_class=2, nb_gpu=1):
        ...
        ## Convolution Layers
        l = Conv2D(64, (6, 6), padding='same', activation='relu', kernel_constraint=maxnorm(3))(x)
        l = Dropout(0.2)(l)
        l = Conv2D(64, (6, 6), activation='relu', padding='same', kernel_constraint=maxnorm(3))(l)
        l = MaxPooling2D(pool_size=(2, 2))(l)
        l = Conv2D(64, (6, 6), padding='same', activation='relu', kernel_constraint=maxnorm(3))(l)
        l = Dropout(0.2)(l)
        l = Conv2D(64, (6, 6), activation='relu', padding='same', kernel_constraint=maxnorm(3))(l)
        l = MaxPooling2D(pool_size=(2, 2))(l)
        l = Conv2D(64, (6, 6), padding='same', activation='relu', kernel_constraint=maxnorm(3))(l)
